    ...
    let steps = [
        {
            ...
            description:
                "Vision Cursor is a Python project implementing Computer vision techniques to control mouse cursor using camera and hand movement including clicks and scroll",
        },
        {
            name: "Utlimate Todos",
...
<main class="flex flex-col flex-1 p-4">
    ...
    >
        ...
        >
            <h2 class="font-semibold text-4xl sm:text-5xl md:text-6xl">
                Hi! I'm <span class="poppins text-violet-400">Ayush</span> Sharma
                <br />Software
                <span class="poppins text-violet-400">Developer</span>
            </h2>
            <p class="text-base sm:text-lg md:text-xl">
                My <span class="text-violet-400"> favorite tech</span> includes JavaScript
                (NEXT.JS or SvelteKit), TailwindCSS, Node.js!
            </p>
            <button
    ...
    <section class="py-20 lg:py-32 flex flex-col gap-24" id="projects">
        ...
        <a
            href="https://www.youtube.com/theofficialayush"
            target="_blank"
